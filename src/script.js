class QuoteMachine extends React.Component {
  ...
  render() {
    ...
    return (
      <div class="d-flex flex-column justify-content-center"id="container" style={{background: color}}>
        <div class="text-center container-fluid" id="panel" style={{color: color}}>
          <h2>'{quote}'</h2>
          <h3>-{author}-</h3>
          <button
            type="button"
...
ReactDOM.render(<QuoteMachine />, document.getElementById("quote-machine"));
